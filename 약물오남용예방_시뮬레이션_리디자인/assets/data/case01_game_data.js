            ...
            witnesses: [
              {
                ...
                name: "민우",
                label: "체육 수행평가",
                image: "./assets/images/clues/case01/clue_case01_witness_minwoo_face_imagegen.webp",
                preview: "2교시 뒤 체육관 쪽에서 민재를 봤어.",
                text: "민재? 2교시 끝나고 체육관 옆에서 봤어. 레이업 슛 수행평가 연습한다고 농구공을 몇 번 던지긴 했는데, 오래 하진 않았어. 공을 정리하고 교실로 돌아갈 때는 손을 털면서 '오늘 컨디션이 좀 이상하다'고 말했어.",
                isCore: false,
                falseHint: "민우가 본 시간과 장소를 기록했습니다."
              },
              {
                id: "jiwoo",
                name: "지우",
              ...
              },
              {
                ...
                isCore: false,
                falseHint: "서연이 본 점심시간 장면을 기록했습니다."
              },
              {
                id: "haeun",
                name: "하은",
